        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="{{route('admin.createdatadokter')}}"><span class="btn btn-md btn-primary" style="margin-bottom:15px;"><i class="fas fa-plus"></i> Data Dokter</span></a>
...
<script>
  $(document).ready(function(){
    ...
    var url = '{{ route('admin.dashboarddatadokter') }}';
    var tableMaster = $('#tblMaster').DataTable({
      ...
      {data: 'email_dokter', name: 'email_dokter'},
      {data: 'username', name: 'username'},
      {data: 'ttl', name: 'ttl'},
      {data: 'jen_kel_dokter', name: 'jen_kel_dokter', orderable: false, searchable:false},
      {data: 'no_hp_dokter', name: 'no_hp_dokter'},
      {data: 'photo_dokter', name: 'photo_dokter', orderable: false, searchable:false},
