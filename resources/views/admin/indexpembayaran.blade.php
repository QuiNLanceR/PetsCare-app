...
<script>
  $(document).ready(function(){
    ...
    var url = '{{ route('admin.dashboardpembayaran') }}';
    var tableMaster = $('#tblMaster').DataTable({
      ...
      {data: 'photo_pembayaran', name: 'photo_pembayaran', orderable: false, className: 'text-center', searchable:false},
  ...
  function cetakstruk(id) {
    let url = "{{route('admin.cetakstruk',['param1'])}}";
